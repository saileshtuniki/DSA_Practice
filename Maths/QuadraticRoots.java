...
public class QuadraticRoots {
    ...
    public static void findRoots (double a, double b, double c){
        double dirscriminant =  b * b - 4 * a * c;
        double root1, root2;

        if(dirscriminant > 0){
            //Real and distinct roots
            root1 = (-b + Math.sqrt(dirscriminant)/ (2 * a));
            root2 = (-b - Math.sqrt(dirscriminant)/ (2 * a));

            System.out.println("Real and distinct roots:");
            System.out.println("Root1: " + root1);
            System.out.println("Root2: " + root2);
        }else if(dirscriminant == 0){
            ...
            double imaginaryPart = Math.sqrt(-dirscriminant) /(2*a);
